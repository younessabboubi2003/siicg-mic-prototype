...
"""
        ...
        st.markdown('<div class="section-title">Executive Reporting Automation</div>', unsafe_allow_html=True)

        st.markdown("""
        <div class="method-box">
        Génération automatisée d’un rapport exécutif de pilotage consolidant les KPI critiques,
        analyses DOCG, arbitrages et recommandations stratégiques.
        </div>
        """, unsafe_allow_html=True)

        def generate_executive_pdf():
            pdf_path = "SIICG_Executive_Report.pdf"
            ...
            title = Paragraph(
                "<font size=20><b>SIICG — Executive Performance Review Report</b></font>",
                styles['Title']
            )

            subtitle = Paragraph(
                "<font size=11>Plateforme de pilotage de la performance publique — Version de cadrage fonctionnel</font>",
                styles['BodyText']
            )
            ...
            Performance moyenne : <b>{avg_perf:.1f}%</b><br/>
            KPI critiques : <b>{nb_rouge}</b><br/>
            KPI sous vigilance : <b>{nb_orange}</b><br/>
            KPI conformes : <b>{nb_vert}</b><br/>
            Niveau global RPM : <b>{rpm_priority}</b><br/><br/>

            Cette synthèse met en évidence les principaux indicateurs sous tension,
            les programmes nécessitant un arbitrage ainsi que les priorités d’action
            à intégrer dans la prochaine Revue de Performance Mensuelle.
            """
            ...
            elements.append(
                Paragraph(
                    "<b>Programmes & KPI prioritaires</b>",
                    styles['Heading2']
                )
            )
            ...
            • Renforcer le suivi infra-annuel des KPI critiques.<br/>
            • Formaliser les plans d’action correctifs par responsable de programme.<br/>
            • Généraliser les revues de performance mensuelles structurées.<br/>
            • Consolider l’intégration SI des données de pilotage.<br/>
            • Renforcer la gouvernance documentaire et la traçabilité décisionnelle.
            """
            ...
            governance = """
            <b>Lecture gouvernance</b><br/><br/>
            Le SIICG vise à transformer une logique de reporting fragmenté en
            une plateforme intégrée de pilotage stratégique permettant :
            l’alerte précoce, l’analyse décisionnelle, l’arbitrage managérial
            et la capitalisation documentaire du contrôle de gestion public.
            """

            elements.append(Paragraph(governance, styles['BodyText']))
            elements.append(Spacer(1, 30))

            footer = Paragraph(
                "<font size=9 color='#6B7280'>SIICG — Usage interne — Données démonstratives — 2026</font>",
                styles['BodyText']
            )
        ...
        if st.button("📄 Générer Executive Performance Review Report", width="stretch"):
