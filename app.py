...
# TABS
# ============================================================
tab_exec, tab_archi, tab_arbitrage, tab_heatmap, tab_rpm = st.tabs(["Cockpit exécutif", "Architecture SIICG", "Centre d’Arbitrage", "Performance Heatmap", "RPM Executive Mode"])
